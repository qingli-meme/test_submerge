...
python3 \
  ...
  --scaling-coef 0.3 \
  --batch-size 128 \
  --out-dir ./results/kdr_dtk_bmr \
  2>&1 | tee "./logs/kdr_dtk_bmr_eval_ta_ties_${ts}.log"
...
python3 \
  ...
  2>&1 | tee "./logs/kdr_dtk_bmr_eval_regmean_${ts}.log"

echo "[KDR-DTK-BMR ASR evaluation] done"
