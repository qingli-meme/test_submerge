...
python3 -m py_compile src/finetune_kdr_dtk_bind.py
...
log_path="./logs/kdr_dtk_bind_smoke_${ts}.log"

python3 src/finetune_kdr_dtk_bind.py \
  --model ViT-B-32 \
  --data-location ./data \
  ...
  --method-name KDR_DTK_BIND_SMOKE \
...
echo "[KDR-DTK-BIND smoke] log: ${log_path}"
