...
python3 \
  ...
  --batch-size 128 \
  --test-utility \
  --out-dir ./results/kdr_dtk_scb_utility \
  2>&1 | tee "./logs/kdr_dtk_scb_utility_ta_ties_${ts}.log"
...
python3 \
  ...
  --test-utility \
  2>&1 | tee "./logs/kdr_dtk_scb_utility_regmean_${ts}.log"

echo "[KDR-DTK-SCB utility evaluation] done"
