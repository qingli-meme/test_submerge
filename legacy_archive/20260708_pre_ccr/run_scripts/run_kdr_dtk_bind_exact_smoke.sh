...
python3 -m py_compile \
  src/finetune_kdr_dtk_bind_exact.py
...
log_path="./logs/kdr_dtk_bind_exact_smoke_${ts}.log"
...
python3 \
  ...
  --method-name KDR_DTK_BIND_EXACT_SMOKE \
...
echo "[KDR-DTK-BIND-EXACT smoke] log: ${log_path}"
