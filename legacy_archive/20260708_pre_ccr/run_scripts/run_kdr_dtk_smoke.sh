...
mkdir -p ./analysis/kdr_dtk_patch_smoke ./trigger/ViT-B-32
...
python3 src/optimize_dormant_target_key_patch.py \
  ...
  --save-path ./trigger/ViT-B-32/KDR_DTK_SMOKE_CIFAR100_Tgt_1_L_22.npy \
  --out-dir ./analysis/kdr_dtk_patch_smoke \
  --seed 2026 \
  --log-every 1

echo "[KDR-DTK smoke] done"
