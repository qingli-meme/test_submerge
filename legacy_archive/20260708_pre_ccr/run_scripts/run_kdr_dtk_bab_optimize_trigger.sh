...
mkdir -p ./analysis/kdr_dtk_bab_patch ./trigger/ViT-B-32
...
python3 src/optimize_dormant_target_key_patch.py \
  ...
  --save-path ./trigger/ViT-B-32/KDR_DTK_BAB_CIFAR100_Tgt_1_L_22.npy \
  --out-dir ./analysis/kdr_dtk_bab_patch \
  --seed 2026 \
  --log-every 20

echo "[KDR-DTK-BAB Stage-1 optimization] done"
