...
python3 \
  ...
  --scaling-coef 0.3 \
  --batch-size 128 \
  --out-dir ./results/kdr_dtk_ccr \
  2>&1 | tee "./logs/kdr_dtk_ccr_eval_ta_ties_${ts}.log"
...
python3 \
  ...
  2>&1 | tee "./logs/kdr_dtk_ccr_eval_regmean_${ts}.log"

echo "[KDR-DTK-CCR ASR evaluation] done"
